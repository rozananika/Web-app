        ...
        <Box sx={{ pt: 2 }}>
          ...
          <FormControl fullWidth sx={{ mb: 2 }}>
            ...
            >
              ...
              <MenuItem value={WIDGET_TYPES.HEATMAP}>Heat Map</MenuItem>
              <MenuItem value={WIDGET_TYPES.BUBBLE}>Bubble Chart</MenuItem>
              <MenuItem value={WIDGET_TYPES.CORRELATION}>Correlation Chart</MenuItem>
              <MenuItem value={WIDGET_TYPES.TREND}>Trend Chart</MenuItem>
            </Select>
          </FormControl>
            ...
            <Grid item xs={6}>
              <FormControl fullWidth>
                ...
                >
                  ...
                  <MenuItem value={8}>Two-Thirds</MenuItem>
